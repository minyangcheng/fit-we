 ...
 */
public class RefactorFitContainerFragment extends Fragment {
    ...
    public static RefactorFitContainerFragment newInstance(Route routeInfo) {
        RefactorFitContainerFragment fragment = new RefactorFitContainerFragment();
